      ...
      <div>
        ...
        <div className="about">
          <div className="about-photo">
            <img src={require("./images/reb.jpg")} with="300px" height="300px"d></img>
          </div>
          <div className="about-main">
            <div className="about-content">
              <p>I’m a fullstack software engineer with a passion for developing intuitive, responsive, and flexible user experiences.</p>
              <p>I'm highly skilled with various frontend JavaScript libraries and frameworks, including React and AngularJS, as well as server-side technologies including NodeJS, Express, and both SQL and noSQL databases.</p>
